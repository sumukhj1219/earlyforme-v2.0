        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                ...
                <div className="flex flex-1 flex-col gap-4">
                    {
                        (title === "Create" || title == "Edit")&& (<div className="p-2 border-b flex items-start justify-between">
                            <Publish />
                    ...
                    <div className="grid auto-rows-min">
                        <div className={`${viewMode === "Both" && (title === "Create" || title === "Edit") ? "grid md:grid-cols-2 gap-x-2" : "flex flex-col"}`}>
                            {children}
                        </div>
                    </div>
                </div>
