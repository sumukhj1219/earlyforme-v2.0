...
export const pageMetadata: Record<string, PageMeta> = {
  ...
  '/create': {
    ...
    description: 'With the help of highly customizable templates create your waitlists. Publish them to internet without any docover configuration.',
    keywords: [
      'Create waitlists',
      'Publish',
      'multi-tenant',
  ...
  '/assets': {
    title: 'Assets - Manage your icons and images in here to retrive them in future.',
...
export function generateMetadata(pathname: string): Metadata {
  ...
  return {
    metadataBase: new URL(siteConfig.url), // ✅ fixed key name
    ...
    openGraph: {
      ...
      images: [
        {
          url: "/assets/icon.png", // can also be absolute URL
          width: 1200,
          height: 630,
          alt: pageMeta.title,
        },
